package sample.Client2.Model.ClientFactory;

import javafx.scene.image.ImageView;
import sample.Client2.Model.Gif.Gif;
import sample.Client2.Model.Gif.IGif;
import sample.Client2.Model.ImageDate.IImageDate;
import sample.Client2.Model.ImageDate.ImageDate;
import sample.Client2.Model.ServerThread.IServerThread;
import sample.Client2.Model.ServerThread.ServerThread;
...
public class ClientFactory {
    ...
    public static IGameData GameDataCreateInstance(int UserScore, ArrayList<ISpriteData> PlayersGun, boolean GameProcess, ArrayList<IMeteorData> MeteorList, ArrayList<IProjectileData> ProjectileList, ArrayList<IAimData> PlayersAim, IEnterToNumberData enterToNumberData){
